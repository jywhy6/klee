  ...
  case Expr::SExt: {
    ...
    *width_out = ce->getWidth();
    ...
    case Expr::FRem: {
        ...
        return Z3ASTHandle(Z3_mk_fpa_rem(ctx,
                                         left, right),
                           ctx);
    }
  ...
  default:
    ...
    Z3SortHandle Z3Builder::getFloatSortFromBitWidth(unsigned bitWidth) {
        switch (bitWidth) {
            ...
            default:
                assert(0 && "bitWidth cannot converted to a IEEE-754 binary-* number by Z3");
        }
    }

    Z3ASTHandle Z3Builder::castToFloat(const Z3ASTHandle &e) {
    ...
    Z3ASTHandle Z3Builder::getx87FP80ExplicitSignificandIntegerBit(const Z3ASTHandle &e) {
#ifndef NDEBUG
    ...
    bool Z3Builder::addReplacementExpr(const ref<Expr> &e, const Z3ASTHandle &replacement) {
